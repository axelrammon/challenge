<script setup>
  import { deletarAluno, obterAlunoPorId, obterAlunos } from '@/services/alunoService' 
  ...
  import { useRoute } from 'vue-router';
    ...
    onMounted(async () => {
      try {
        const { data } = await obterTurmaPorId(alunoId)
        turma.value.nome = data.nome
...
<template>
  <div class="alunos">   
    <div class="overflow-x-auto table-container">
      <h1 style="text-align: center; padding: 5px; margin: 5px;">{{ turma.nome }}</h1>
